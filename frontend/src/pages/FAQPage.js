...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    { question: "What is the cost of using Carbon Credits?", answer: "The cost of carbon credits can vary depending on the marketplace and the region. The cost per ton of carbon offset may range between $10 and $50. This can also be influenced by supply and demand factors in the marketplace where the credits are traded." },
